    ...
    <KeyboardAwareScrollView>
      <View style={styles.container}>
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <FormPickDate useControllerProps={{ control: useFormReturn?.control, name: "date" }} label="Ngày" required placeholder="Chọn ngày..." />
          <View style={styles.timeRangeContainer}>
            <View style={styles.timeRangeItem}>
              <FormPickTime
                useControllerProps={{ control: useFormReturn?.control, name: "startTime" }}
                label="Giờ bắt đầu"
            ...
            <View style={styles.timeRangeItem}>
              <FormPickTime
                useControllerProps={{ control: useFormReturn?.control, name: "endTime" }}
                label="Giờ kết thúc"
                placeholder="Chọn giờ"
                required
          ...
          <FormSelectV2
            useControllerProps={{ control: useFormReturn?.control, name: "salaryCoefficientTypeId" }}
          ...
          <FormInputMultilne
            ...
            multiline
          />
          <FormUploadImage label="Ảnh đính kèm" useControllerProps={{ control: useFormReturn?.control, name: "attachFile" }} disabled={!isDateDirty} />
