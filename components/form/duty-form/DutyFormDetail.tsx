...
export const DutyFormDetail: React.FC<DutyFormDetailProps> = memo(
  ({ form }) => {
    return (
      <>
        {form && (
          <View style={styles.container}>
            <ScrollView contentContainerStyle={styles.listBox}>
              ...
              <Item
                title="Giờ trực"
                content={`${form.startTime} --> ${form.endTime}`}
              />

              <Item
                title="Loại trực"
                content={
                  <DutyFormDetailDutyTypes formDutyTypes={form.dutyTypes} />
                }
              />
              <Item
                ...
                } (x${form.salaryCoefficient.toFixed(2)})`}
              />

              <Item
                title="Nội dung công việc"
                content={form.note ?? "Không có dữ liệu"}
              />
