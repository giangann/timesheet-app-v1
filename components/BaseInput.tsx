...
export function BaseInput({ placeholder, leftIconImage, rightIconImage, rightIconEl, error, ...rest }: BaseInputProps) {
  return (
    <View style={{ position: "relative", marginBottom: 8 }}>
      {/* input */}
      <TextInput placeholder={placeholder} style={inputStyles.default} {...rest} />
