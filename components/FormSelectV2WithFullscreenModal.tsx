...
function RawFormSelectV2WithFullscreenModal<T extends FieldValues>({
  label,
  placeholder,
  required,
  error,
...
export const FormSelectV2WithFullscreenModal = memo(RawFormSelectV2WithFullscreenModal) as typeof RawFormSelectV2WithFullscreenModal;
