...
export enum CALENDAR_COLOR {
  MAU_KHOI = '#616161',
  MAU_OAI_HUONG = '#7986cb',
  MAU_NHO = '#8e24aa',
  MAU_XANH_LAM= '#039be5',
  MAU_VIET_QUAT= '#3f51b5',
  MAU_XANH_LA_NHAT= '#33b679',
  MAU_HUNG_QUE= '#0b8043',
  MAU_CAM= '#f4511e',
  MAU_CHUOI= '#f6bf26',
  MAU_DO_CA_CHUA= '#d50000',
  MAU_HONG_BAC= '#e67c73'
}
...
export const EVENT_COLOR = {
  [EVENT_ITEM_PREFIX.CALENDAR]: CALENDAR_COLOR.MAU_HUNG_QUE,
  [EVENT_ITEM_PREFIX.DUTY_FORM]: CALENDAR_COLOR.MAU_NHO,
  [EVENT_ITEM_PREFIX.LEAVE_FORM]: CALENDAR_COLOR.MAU_XANH_LAM,
};
